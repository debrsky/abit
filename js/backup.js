(() => {
  ...
  var require_vuvuzela = __commonJS({
    "node_modules/vuvuzela/index.js"(exports) {
      "use strict";
      exports.stringify = function stringify3(input2) {
        var queue2 = [];
        queue2.push({ obj: input2 });
        var res = "";
  ...
  function merge(tree, path2, depth) {
  ...
  function massageSelector(input2) {
    var result = clone(input2);
    var wasAnded = false;
  ...
  function evalFilter(input2) {
    return scopeEval('"use strict";\nreturn ' + input2 + ";", {});
  }
  function evalView(input2) {
    var code = [
      "return function(doc) {",
      '  "use strict";',
      "  var emitted = false;",
  ...
  function HttpPouch(opts, callback) {
    ...
    api.fetch = function(path2, options) {
      return setup().then(function() {
        var url = path2.substring(0, 1) === "/" ? genUrl(host, path2.substring(1)) : genDBUrl(host, path2);
    ...
    api.get = adapterFun$$1("get", function(id, opts2, callback2) {
      ...
      function fetchAttachments(doc) {
        ...
        function fetchData(filename) {
          var att = atts[filename];
          var path2 = encodeDocId(doc._id) + "/" + encodeAttachmentId(filename) + "?rev=" + doc._rev;
          return ourFetch(genDBUrl(host, path2)).then(function(response) {
  ...
  function createAbstractMapReduce(localDocName2, mapper2, reducer2, ddocValidator2) {
    ...
    function updateViewInQueue(view, opts) {
      ...
      function emit2(key, value) {
        var output2 = { id: doc._id, key: normalizeKey(key) };
        if (typeof value !== "undefined" && value !== null) {
          output2.value = normalizeKey(value);
        }
  ...
  var input = document.forms.form.file;
  var btnLoadFakeData = document.getElementById("load-fake-data");
  var output = document.getElementById("output");
  var selectFileHandler = (event) => {
  ...
  async function createAbitsView(db2) {
    const abits = {
      _id: "_design/abits",
      views: {
        abits: {
